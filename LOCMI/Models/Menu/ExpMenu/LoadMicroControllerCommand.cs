...
{
    private readonly CertifierExperimentalDTO _certifier;
    ...
    public LoadMicrocontrollerCommand(CertifierExperimentalDTO certifier, ScannerController scannerController)
    {
